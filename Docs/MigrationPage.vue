<template>
  <div class="markdown-body container-lg px-3 my-5">
    ...
    <p>Several behavioral differences exist between Artifact actions <code>v3</code> and <code>v4</code>. This document outlines how common scenarios differ.</p>
  </div>
</template>
